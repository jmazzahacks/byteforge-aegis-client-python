...
class AegisClient:
    ...
    def _require_site_id(self, site_id: Optional[str] = None) -> str:
        """Get the site UUID from argument or config, raising if neither available."""
    ...
    def register(
        self, email: str, password: Optional[str] = None, site_id: Optional[str] = None
    ) -> MessageResponse:
    ...
    def request_password_reset(
        self, email: str, site_id: Optional[str] = None
    ) -> MessageResponse:
    ...
    def register_admin(
        self, email: str, site_id: str, role: Optional[str] = None
    ) -> User:
    ...
    def get_site(self, site_id: str) -> Site:
        """Get a site by UUID. GET /api/sites/{site_id}"""
        self._require_master_api_key()
    ...
    def list_users_by_site(self, site_id: str) -> List[User]:
        """List users for a site. GET /api/sites/{site_id}/users"""
        self._require_master_api_key()
        data = self._http.request('GET', f'/api/sites/{site_id}/users')
        return [User.from_dict(u) for u in data]

    def get_user(self, user_id: str, site_id: Optional[str] = None) -> User:
    ...
    def update_site(self, site_id: str, updates: UpdateSiteRequest) -> Site:
    ...
    def aegis_admin_list_users_by_site(
        self, site_id: str, admin_token: str
    ) -> List[User]:
